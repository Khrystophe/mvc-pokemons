...
-- Listage de la structure de la base pour poke
CREATE DATABASE IF NOT EXISTS `poke` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `poke`;

-- Listage de la structure de table poke. pokemon
CREATE TABLE IF NOT EXISTS `pokemon` (
  ...
  KEY `number` (`number`)
) ENGINE=InnoDB AUTO_INCREMENT=1360 DEFAULT CHARSET=utf8mb3;

-- Listage des données de la table poke.pokemon : ~151 rows (environ)
...
-- Listage de la structure de table poke. pokemon_type
CREATE TABLE IF NOT EXISTS `pokemon_type` (
  ...
  CONSTRAINT `pokemon_type_ibfk_1` FOREIGN KEY (`type_id`) REFERENCES `type` (`id`),
  CONSTRAINT `pokemon_type_ibfk_2` FOREIGN KEY (`pokemon_number`) REFERENCES `pokemon` (`number`)
) ENGINE=InnoDB AUTO_INCREMENT=646 DEFAULT CHARSET=utf8mb3;

-- Listage des données de la table poke.pokemon_type : ~0 rows (environ)
...
-- Listage de la structure de table poke. type
...
-- Listage des données de la table poke.type : ~0 rows (environ)
